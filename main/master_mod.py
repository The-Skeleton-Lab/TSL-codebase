...
class master_module:
    ...
    def createMaster(self, base_rig_group=None, asset_name="", shape_scale=2):
        ...
        # createNetwork_grps
        master_network = tr.create_transform(
            Trname="master_network", make_local=False, parent=base_grp
        )
        ...
        # create guides
        master_gd = tr.create_transform(
            Trname="master_guide", make_local=False, parent=base_grp, inheritTransform=0
        )
        guide_01 = tr.create_transform(
            Trname="master",
            typ="guide",
            make_local=False,
            parent=master_gd,
        ...
        # create controls
        master_ct = tr.create_transform(
            Trname="master_ctrl", make_local=False, parent=base_grp, inheritTransform=0
        )

        main_ctrl = cm.create_control(
            basename="master",
            curveType="Four Arrows",
            sub_controls=3,
            zgrps=0,
        ...
        # create skeleton
        master_sk = tr.create_transform(
            Trname="master_jnt", make_local=False, parent=base_grp, inheritTransform=0
        )

        root_skel = tr.create_transform(
            Trname="root", typ="joint", parent=master_sk, root_joint=True
        )
        ...
        utz.add_world_mtxs_to_output(
            output_ntw, main_ctrl[1], custom_name="end_ctrl_out"
        )
